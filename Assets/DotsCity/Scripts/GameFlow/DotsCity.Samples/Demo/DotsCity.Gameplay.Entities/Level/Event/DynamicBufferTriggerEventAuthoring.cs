...
namespace Unity.Physics.Stateful
{
    ...
    public partial class TriggerEventConversionSystem : SystemBase
    {
        ...
        protected static void AddTriggerEventsToDynamicBuffers(NativeList<StatefulTriggerEvent> triggerEventList,
            ref BufferLookup<StatefulTriggerEvent> bufferFromEntity, NativeParallelHashMap<Entity, byte> entitiesWithTriggerBuffers)
        {
        ...
        protected override void OnUpdate()
        {
            ...
            Dependency = JobHandle.CombineDependencies(simulationSingleton.AsSimulation().FinalSimulationJobHandle, Dependency);
            ...
            var triggerEventBufferFromEntity = GetBufferLookup<StatefulTriggerEvent>();
            ...
            var collectJobHandle = collectTriggerEventsJob.Schedule(simulationSingleton, Dependency);
    ...
    public class DynamicBufferTriggerEventAuthoring : MonoBehaviour
    {
        public class DynamicBufferTriggerEventBaker : Baker<DynamicBufferTriggerEventAuthoring>
        {
            public override void Bake(DynamicBufferTriggerEventAuthoring authoring)
            {
