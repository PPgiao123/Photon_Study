...
{
    /// <summary>
    /// An example of a player NPC interacting with traffic when the player car & traffic car have different motion controllers, using a sample raycaster.
    /// </summary>
    public class PlayerInteractorCastAndSwitchExample : PlayerInteractorSwitchExample
    {
