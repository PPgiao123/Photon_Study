...
{
    public class PathArrowLightDataViewer : PathDataSimpleParamViewerBase<bool>
    {
        protected override string PathTypeSaveKey { get => $"PathArrowLight_ColorDictionary"; set => base.PathTypeSaveKey = value; }
        ...
        {
            return path.CustomLightHandler != null;
        }
